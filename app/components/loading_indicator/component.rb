...
module LoadingIndicator
  class Component < ViewComponent::Base
    ...
    COLORS = %i[neutral accent cream tan primary red orange yellow green blue purple pink].freeze

    # @param type [Symbol] Loading indicator type: :spinner, :dots, :bars, :progress
    # @param size [Symbol] Size: :xs, :sm, :md, :lg, :xl
    # @param color [Symbol] Color variant: :neutral, :accent, :cream, :tan, :primary, :red, :orange, :yellow, :green, :blue, :purple, :pink
