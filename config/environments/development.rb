...
Rails.application.configure do
  ...
  # Mailers have no request to derive the host from, so it has to be configured.
  # Set APP_HOST when testing through the Cloudflare tunnel, otherwise links in
  # dev mail point at localhost and are dead on any other device.
  config.action_mailer.default_url_options = if ENV["APP_HOST"].present?
